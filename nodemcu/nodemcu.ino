...
void loop() {
  if (count == 1) {
    ...
    http.begin(client, "http://dkgproject.000webhostapp.com/dbwrite.php");  // Connect to host where MySQL databse is hosted
    ...
    http.begin(client, "http://dkgproject.000webhostapp.com/dbread.php");  // Connect to host where MySQL databse is hosted
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");       // Specify content-type header
